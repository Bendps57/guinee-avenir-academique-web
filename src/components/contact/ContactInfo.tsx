...
const SocialLinks = () => {
  return (
    <div className="flex space-x-4">
      ...
      <a href="https://www.linkedin.com/company/iuheg-institut-universitaire-des-hautes-etudes-de-guinée/" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-university-blue">
