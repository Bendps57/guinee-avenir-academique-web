          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-gray-300">123 Boulevard de l'Université, Conakry, Guinée</span>
              </li>
              <li className="flex items-center">
              ...
              <li className="flex items-center">
                ...
                <a href="tel:+224123456789" className="text-gray-300 hover:text-university-gold">+224 12 345 6789</a>
              </li>
            </ul>
          </div>
        </div>
