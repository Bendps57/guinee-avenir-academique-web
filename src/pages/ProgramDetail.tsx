...
const ProgramDetail = () => {
    ...
    return (
      <div className="min-h-screen pt-20">
        <div className="container mx-auto px-4 py-12 text-center">
          ...
          <button className="bg-university-blue text-white px-4 py-2 rounded hover:bg-university-navy">
  ...
  // Special rendering for Marketing International
  if (program.id === "marketing-commerce-international") {
    return (
      <ProgramContent
  ...
  // Special rendering for Économie Appliquée
  if (program.id === "economie-appliquee") {
    return (
      <ProgramContent
  ...
  // Special rendering for Économie Internationale
  if (program.id === "economie-internationale") {
    return (
      <ProgramContent
  ...
  return (
    <DefaultProgramDetail program={program} />
  );
};
